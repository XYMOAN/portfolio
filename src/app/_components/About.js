            ...
            {skills.map((skill, index) => (
              <div key={index} className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3">
                <GlowingEffect
                  ...
                  inactiveZone={0.01}
                />
                <div className="bg-neutral-900 border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D] shadow-s-pressed">
